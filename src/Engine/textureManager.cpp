...
void TextureManager::createTextureImage(const std::string &path) {
  ...
  // Create staging buffer (simplified buffer creation here, ideally reuse
  // MeshHandler logic or BufferManager)
...
void TextureManager::createTextureSampler() {
  ...
  samplerInfo.anisotropyEnable = VK_FALSE; // Enable if feature available
